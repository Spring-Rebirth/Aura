...
export async function signIn(email, password) {
    ...
    try {
        ...
        console.log('Session created:', newSession);  // 输出新创建的会话信息
        return newSession;
    } catch (error) {
...
export async function getUserPosts(userId) {
    return await fetchData(config.databaseId, config.videosCollectionId, [Query.equal('creator', userId)], 'Failed to get user posts');
}
